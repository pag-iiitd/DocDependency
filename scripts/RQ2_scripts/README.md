...
3.  Open the _Windows Command line interpreter (cmd.exe)_, referred to as the command prompt in the following steps, and change directory to 'project_folder'.        
